...
import time
import pandas as pd
import cryptoqt.bsim.runalpha_test as runalpha
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dst',  help='dst', default='/home/crypto/signal/predv25_2w2')
            ...
            try:
                if not str(dr["min1info_tm"][min1i]) in ddates:
                    ...
                    bookw, long, short = runalpha.calcwtopkliqV3(dr, min1i, alpha.copy(),
                                        money=20000, tratio=0.05, lastbookw=lastbookw, 
                                        top_limit=10,
                                        ratio_limit=50, money_limit=5000000)
