...
if __name__ == "__main__":
    ...
    path="/home/crypto/sec_klines_env/cryptoqt/smlp/model_states/infmodel/smlpv25_2/res"
    ...
    aa=run_alpha(int(conts.h1mincnt/12), partial(min15_alpha.readcsv_v2avg,
            path=path),
            path=path,
            ...
            calcw=partial(calcwtopkliqV3, ratio_limit=100, scale=4, money_limit=5000000, 
