...
if __name__ == "__main__":
    ...
    parser.add_argument('--dst',  help='dst', default='/home/nb/signal/predv260_10_0.5w')
            ...
            try:
                if not str(dr["min1info_tm"][min1i]) in ddates:
                    ...
                    bookw, long, short = runalpha.calcwtopkliqV3(dr, min1i, alpha.copy(),
                                        money=100000, tratio=0.5, lastbookw=lastbookw, 
                    ...
                    if tm > 20241218000000:
                        retryscp(args.dst+"/"+str(tm)+"_book.csv", "/home/ubuntu/signal/predv260_10_0.5w/")
