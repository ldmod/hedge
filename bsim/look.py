...
def update_positions(client: UMFutures, position_value_map: dict) -> bool:
    try:
...
if __name__ == '__main__':
    ...
    current_index = int(20240830141500)
    ...
    while True:
        ...
        if current_time.minute:
            ...
            total_account_value = get_account_value(client)

            logger.info(f"账户净值$: {get_account_value(client)}")
            update_positions(client, available_token_map)
